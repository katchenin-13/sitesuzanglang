    ...
    <div class="col-md-10 ">
        ...
        <div class="card card-primary">
                <div class="card-header" style="background-color: #64350d !important;" >
                  <h3 class="card-title"><i class="fas fa-user-plus fa-2x"></i> Formulaire de modifiction d'un nouvel Client </h3>
                </div><!-- /.card-header -->
                    <!-- form start -->
                <form role="form" wire:submit.prevent=" updatePost({{$edit_id}})">
                       @csrf             
                    <div class="col-md-12">
                        <div class="card-body">
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <select  class="form-control" wire:model="edit_categorie">
                                <option value=""></option>
                          ...
                          <div class="p-4" >
                            ...
                            <div class="custom-file mt-3">
                              ...
                              <label class="custom-file-label" for="customFile">Choisie un fichier</label>
                           </div>
                           @if ($new_imageUrl)
