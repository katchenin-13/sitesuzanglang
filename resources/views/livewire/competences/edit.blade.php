    ...
    <div class="col-md-10 ">
        ...
        <div class="card card-primary">
                <div class="card-header" style="background-color: #64350d !important;" >
                  <h3 class="card-title"><i class="fas fa-user-plus fa-2x"></i> Formulaire de modifiction d'une nouvelle compétence </h3>
                </div><!-- /.card-header -->
                    <!-- form start -->
                <form role="form" wire:submit.prevent=" updateCompetence({{$edit_id}})">
                       @csrf             
                    <div class="col-md-12">
                        <div class="card-body">
                         ...
                         <div class="form-group">
                          ...
                          <div class="form-group">
                             ...
                             <div class="col-md-12" wire:ignore >
                                  <input type="number" id="edit_extrait" class="form-control @error('edit_extrait') is-invalid @enderror"  wire:model="edit_extrait">
                             </div>  
                             @error("edit_extrait")
                                <span class="text-danger">{{ $message }}</span>
                             @enderror
                  ...
                  {{-- </div> --}}
                        ...
                        <div class="card-footer">
                            <div class="float-right">
                              <button type="button" wire:click="goToListCompetence()" class="btn btn-danger">Retouner à la liste des competences</button>
                            </div>
