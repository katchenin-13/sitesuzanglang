      ...
      <div class="card-body table-responsive p-0 table-striped" style="height:350px;">
        <table class="table table-head-fixed">
          ...
          <tbody>
            ...
            <tr>
              <td><img src="{{asset('storage')}}/{{$client->imageUrl}}" style="width: 70px;height:70px;" alt="">
              </td>
              <td>{{$client->titre}}</td>
              <td>{{$client->extrait}} </td>
              <td>
              ...
              <td class="text-center">
                <button class="btn btn-link" wire:click="goToEditClient({{$client->id}})"> <i class="far fa-edit"></i>
                </button>
                <button class="btn btn-link" wire:click="confirmDelete('{{ $client->titre }}', {{$client->id}})"> <i
